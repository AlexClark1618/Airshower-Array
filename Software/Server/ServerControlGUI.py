...
SERVER_SCRIPT = r"//home//alexc//Array Server//GPS_DAQ_Server.py"
...
DEVICE_IDS = {
    "BH":    128,
    "Veto":  16,
    "Det 1": 112,   # placeholder – fill in actual mac_id
    "Det 2": 180,
    "Det 3": 104,
    "Det 4": 64,
    "Det 5": 216,
...
class GPSDAQApp:
    ...
    def _build_gps_tab(self, parent):
        ...
        self.svin_acc_entry.insert(0, "10000")   # 1 m default
    ...
    def _build_autosurvey_tab(self, parent):
        ...
        self.as_dur_entry.insert(0, "86400")
        ...
        self.as_acc_entry.insert(0, "10000")   # 1 m default
